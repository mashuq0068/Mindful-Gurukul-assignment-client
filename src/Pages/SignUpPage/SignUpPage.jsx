...
const SignUp = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const form = e.target 
     ...
     const selectedSources = Array.from(form.querySelectorAll('input[name="source[]"]:checked')).map(checkbox => checkbox.value);
     console.log(name  , email , password , phone ,gender , selectedSources , selectedState)
  ...
  <div className=" w-full flex-col ">
    ...
    <div className=" flex-shrink-0 w-full  h-auto shadow-black shadow-lg bg-base-100">
